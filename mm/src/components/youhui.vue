      ...
      data(){
        ...
        youhui:[
          ...
          tiaozhuan:["xinpin","xifu","waitao","chenshan","zhenzhishan","poloshan","ku","lindai","xiezi","peishi","yanjing","youhui"],
             big:{
            color:["棕色","灰色","白色","紫色","红色","绿色","蓝色","黑色","米色"],
...
{
    if(this.youhui[index].info===this.shopcar[i].info)
    {
        alert('已存在商品');
...
if(i>=this.shopcar.length)
{
   ...
   alert("请登录");
      ...
      this.shopcar.push({
      id:this.youhui[index].id,
      img:this.youhui[index].img,
      info:this.youhui[index].info,
      price:this.youhui[index].price,
      count:this.youhui[index].count,
...
else
{
  ...
  this.youhui.forEach(function(item,index){
      var count=0;
