...
export default {
  ...
  add(index){
          ...
          {
          if(this.cloth[index].info===this.shopcar[i].info)
          {
              alert('已存在商品');
      ...
      if(i>=this.shopcar.length)
      {
        ...
        alert("请登录");
            ...
            this.shopcar.push({
            id:this.cloth[index].id,
            img:this.cloth[index].img,
            info:this.cloth[index].info,
            price:this.cloth[index].price,
            count:this.cloth[index].count,
  ...
  this.cloth.forEach(function(item,index){
      var count=0;
