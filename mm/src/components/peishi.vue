...
export default {
        ...
        return{
         ...
         peishi:[
          ...
          tiaozhuan:["xinpin","xifu","waitao","chenshan","zhenzhishan","poloshan","ku","lindai","xiezi","peishi","yanjing","youhui"],
            big:{
            color:["棕色","灰色","白色","紫色","红色","蓝色","黑色"],
           leibie:["内衣","围巾","帽子及手套","毛巾","短裤","袜子"]
          },
          have:[],
          cloth2:[],
          shai:[]
    ...
    for(var i =0;i<this.shopcar.length;i++)
      {
          if(this.peishi[index].info===this.shopcar[i].info)
          {
              alert('已存在商品');
        ...
        if(i>=this.shopcar.length)
        {
          ...
          alert("请登录");
              ...
              this.shopcar.push({
              id:this.peishi[index].id,
              img:this.peishi[index].img,
              info:this.peishi[index].info,
              price:this.peishi[index].price,
              count:this.peishi[index].count,
  ...
  this.peishi.forEach(function(item,index){
      var count=0;
