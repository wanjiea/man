<template>
    <div id="big">
     ...
     <h1>Polo 衫与 T 恤</h1>
      ...
      <div class="lbottom">
          <ul>
              <li v-for="(item,index) in poloshan">
...
export default {
   ...
   add(index){
    ...
    {
        if(this.poloshan[index].info===this.shopcar[i].info)
        {
            alert('已存在商品');
    ...
    if(i>=this.shopcar.length)
    {
      ...
      alert("请登录");
          ...
          this.shopcar.push({
          id:this.poloshan[index].id,
          img:this.poloshan[index].img,
          info:this.poloshan[index].info,
          price:this.poloshan[index].price,
          count:this.poloshan[index].count,
  ...
  this.poloshan.forEach(function(item,index){
      var count=0;
