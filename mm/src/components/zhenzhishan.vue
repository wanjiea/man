<template>
    <div id="big">
     ...
     <h1>针织衫</h1>
      ...
      <div class="lbottom">
          <ul>
              <li v-for="(item,index) in zhenzhishan">
...
{
    if(this.zhenzhishan[index].info===this.shopcar[i].info)
    {
        alert('已存在商品');
...
if(i>=this.shopcar.length)
{
   ...
   alert("请登录");
      ...
      this.shopcar.push({
        id:this.zhenzhishan[index].id,
      img:this.zhenzhishan[index].img,
      info:this.zhenzhishan[index].info,
      price:this.zhenzhishan[index].price,
      count:this.zhenzhishan[index].count,
...
else
{
  ...
  this.zhenzhishan.forEach(function(item,index){
      var count=0;
