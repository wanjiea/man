<template>
    <div id="big">
      ...
      <div id="bigContent">
        <div id="nav">
        <div id="navImg" style="color:#000">
          <router-link to="/" style="color:#000">男人装</router-link>
        </div>
        <div id="navList">
          <ul id="navList-ul">
            <li v-for="(ii,index) of  navList" @click="xiala(index)" style="color:#000">
              {{ii.title}}
      ...
      <div id="nav2" style="color:#000">
        ...
        <div class="topBarItem">
          <router-link to="/account" style="color:#000;">我的账户</router-link>
        </div>
         <div class="topBarItem">
          <router-link to="/cart" style="color:#000;">购物车</router-link>
        </div>
      </div>

      <!-- 顶部 -->
      <!-- <div id="top" style="height:650px">
        <div id="fm1">
          <img src="../../static/Atr-m/bg.jpg" alt="">
        </div>
        <div id="title-wrap" class="oneTitle" style="top:50%">
          <p style="font-weight:700;font-size:18px;margin-bottom: 28px; ">THE ART OF TAILORING </p>
          <p style="font-weight:400;font-size:11px; ">
            <span style="cursor:pointer;font-size: 12px;letter-spacing: .16em;">WATCH THE VIDEO</span> </p>
        </div>
      </div> -->
      <!-- 内容开始 -->
        <div class="actor-m">
            <div>
                <div>
                    <img src="../../static/ActorTwo-m/bg.jpg" alt="">
                    </div>
                <div class="actor-m-r">
                 <div>
                   <h2>ARMIE HAMMER 与 BRIONI</h2>
                    <p>
                        Brioni 宣布 Armie Hammer 将出镜 2019 春夏广告大片 <br>
                       好莱坞新一代杰出演员之一，曾参演《社交网络》（The Social Network）、《秘密特工》（The Man from U.N.C.L.E）、《请以你的名字呼唤我》（Call Me by Your Name）与《以性为本》（On the Basis of Sex）等电影。Armie Hammer 本色演绎 Brioni 摩登绅士：优雅从容、意志坚定而极富个人魅力。
                    </p> 
                 </div>
            ...
            <div>
                <img src="../../static/ActorTwo-m/bg1.jpg" alt="">
            </div>

            <div>
                <div style="width:54%;margin:0 auto;">
                <img src="../../static/ActorTwo-m/bg2.jpg" alt="">
                </div>
            </div>

            <div>
                <img src="../../static/ActorTwo-m/bg3.jpg" alt="">
            </div>
        </div>
      ...
      <!-- 最底下三个图 -->
      <div id="top3" style="height:50px">
      </div> 
      <div id="foot" style="margin-bottom:30px">
        <div id="footInner">
          <p> 
...
.actor-m>div:nth-child(1){
    display: flex;
    justify-content: space-around;
}
.actor-m>div:nth-child(1)>div{
    flex:1;
}
.actor-m img{
    width: 100%;
